...
def init():
    ...
    return (model, face_detector, open_eyes_detector, left_eye_detector, right_eye_detector, video_capture, qr_code_alpha_channel)
    ...
    for filename in os.listdir(dataset):
        if filename.endswith('.json'):
            ...
            with open(filepath, 'r') as f:
                ...
                known_face_names.append(data['file_name'])
...
if __name__ == "__main__":
    (model, face_detector, open_eyes_detector, left_eye_detector, right_eye_detector, video_capture, qr_code_alpha_channel) = init()
